            ...
            if robot_id in positions:
                # try:
                    ...
                    while i < len(points):
                        ...
                        robot_orient = np.deg2rad(rotations[robot_id])                      # robot orientation, (rotations) deg --> rad
                        robot_pos = [positions[robot_id][0], positions[robot_id][1]]        # robot position
                        dist = math.dist(robot_pos, p)                                      # distance to point

                        desired_orient = ( math.atan2( ((p[1]-robot_pos[1])) , ((p[0]-robot_pos[0]) ))  )       # desired orientation, rad
                        ...
                        if dist < 0.3 and orient_err < 0.2:
